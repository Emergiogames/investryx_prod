            ...
            <div className="lg:h-screen bg-center bg-no-repeat md:bg-[url('/images/signIn_one.png')] md:bg-cover">
                <div className="flex  justify-center h-screen">
                    ...
                    <div className="flex items-center justify-center md:w-1/2 ">
                        <div className=" max-w-md w-full px-8 pb-8 hover:scale-105 transition-transform duration-500">
                            ...
                            <h2 className="text-2xl font-semibold mb-5">
                                <span className="text-6xl text-yellow-300 font-extrabold ">W</span>
                            ...
                            <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={submit}>
                                <Form className="max-w-md mx-auto">
                                    ...
                                    <div className="text-sm  text-black flex justify-end mb-6"></div>
                    ...
                    <div className="hidden md:flex md:w-1/2 items-center"></div>
                </div>
            </div>
        </>
    );
