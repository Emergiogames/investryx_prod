                    ...
                    <div className="w-full flex flex-col lg:flex-row items-center px-4 lg:px-16">
                        ...
                        <div className="w-full lg:w-1/2">
                            <div className="w-full flex flex-col justify-center items-center mt-8 lg:mt-16">
                                ...
                                A business valuation calculator estimates a company's worth based on financial metrics, market trends, and growth potential, helping investors make informed decisions and assess investment opportunities.
                                New chat
                                </div>
                            </div>
                            <div
