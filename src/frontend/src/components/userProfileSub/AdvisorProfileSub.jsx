...
import { getAdvPost } from "../../services/user/apiMethods";
...
function AdvisorProfileSub(props) {
    ...
    console.log("myRecommAdv ::", recommPlan);
                        ...
                        <div className="p-6 m-6  bg-amber-100 rounded-md text-center ">
                            ...
                            <div>
                                <div className="my-6 flex justify-center mt-16">
                                    <button
                                        onClick={() => navigate("/add-Profile-pre-advisor")}
...
export default AdvisorProfileSub;
