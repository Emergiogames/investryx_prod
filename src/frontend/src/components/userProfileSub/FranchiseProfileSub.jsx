...
import { getFraPost, deleteProfile } from "../../services/user/apiMethods";
...
function FranchiseProfileSub(props) {
    ...
    console.log("myRecommFra ::", recommPlan);
    const selectedUser = (state) => state.auth.user || "";
    const user = useSelector(selectedUser);

    //handle Add Post check
    const handleAddPost = () => {
        const pass = "franchise";
        navigate("/add-post");
    };
                        ...
                        <div className="p-6 m-6  bg-amber-100 rounded-md text-center ">
                            ...
                            <div>
                                <div className="my-6 flex justify-center mt-16">
                                    <button
                                        onClick={() => navigate("/add-Profile-pre-franchise")}
...
export default FranchiseProfileSub;
