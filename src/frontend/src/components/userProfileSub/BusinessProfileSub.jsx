...
import { getBusPost } from "../../services/user/apiMethods";
...
function BusinessProfileSub(props) {
            ...
            <div className="bg-slate-50">
                ...
                <div className="xl:flex">
                    ...
                    <div className="xl:w-1/2 min-h-[90vh]">
                        ...
                        {/* my listed posts start */}
                        <MyPostsList myPosts={myPosts} />
                        {/* my listed posts ending */}
                    </div>
                        ...
                        <div className="p-6 m-6  bg-amber-100 rounded-md text-center ">
                            ...
                            <div>
                                <div className="my-6 flex justify-center mt-16">
                                    <button
                                        onClick={() => navigate("/add-Profile-pre-business")}
                            ...
                            <div className=" w-full mb-5 flex">
                                <div className="text-violet-900 pl-5">
                                    <div className=" text-xl font-light text-left">
                                        Plan Expiry : {myPlan && myPlan?.expiry}
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default BusinessProfileSub;
