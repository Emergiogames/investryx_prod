            ...
            <div className="xl:grid xl:grid-cols-2 xl:gap-8">
              <div className="space-y-4">
                ...
                <div className="xl:flex justify-end">
                  ...
                  Investryx bridges the gap between demand and supply across all business sectors, fostering seamless connections and enhancing opportunities for sustainable growth.
                  </p>
                </div>
