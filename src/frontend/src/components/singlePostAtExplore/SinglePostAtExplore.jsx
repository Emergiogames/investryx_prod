...
import SinglePostLoader from "../loader/SinglePostLoader";

const SinglePostAtExplore = ({ props }) => {
                            ...
                            {post.entity_type === "advisor" ? (
                                <div className="relative mb-4">
                                    {post.logo ? (
                                        ...
                                        <div onClick={() => handleViewPost(post)} className="h-60 lg:h-80 w-full object-cover flex justify-center items-center rounded-2xl transition-transform duration-300 transform group-hover:scale-105">
