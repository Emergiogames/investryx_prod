...
const BusinessList = () => {
  ...
  switch(postData.entity_type) {
    case "business":
      navigate("/admin/viewPostBusiness", {state: {postData: postData}});
      break;
    case "investor":
      navigate("/admin/viewPostInvestor", {state: {postData: postData}});
      break;
    case "franchise":
      navigate("/admin/viewPostFranchise", {state: {postData: postData}});
      break;
    case "advisor":
      navigate("/admin/viewPostAdvisor" , {state: {postData: postData}});
      break;
    default:
    ...
    return (
        <>
            <div className="w-9/12">
                ...
                <div className=" flex justify-center items-center font-serif text-xl mt-6 ">Post Approval Management</div>
                                    ...
                                    <tbody>
                                        {currentPosts.map((post, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 text-center" onClick={() => handleViewPost(post)}>
                                                    <img
                                                        src={
                                                            post.image1
                                                ...
                                                <td className="px-6 py-4 text-center">{post?.city ? post?.city : "n/a"}</td>
                                                <td className="px-6 py-4 text-center">
                                                    {post?.state ? post.state : "n/a"}
                                                </td>
                                                <td className="px-6 py-4 text-center">
