    ...
    return (
        <>
            <div className="w-9/12">
                <div className=" flex justify-center items-center font-serif text-xl mt-6 ">Franchise Posts List</div>
                                        ...
                                        {currentPosts.map((post, index) => (
                                            ...
                                            >
                                                ...
                                                <td
                                                    ...
                                                    onClick={() =>
                                                        navigate(`/admin/viewPostFranchise?post=${post.id}`, {
                                                            state: { postData: post },
                                                        })
                                                    }
                                                >
