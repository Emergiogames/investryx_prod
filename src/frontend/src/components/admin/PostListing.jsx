...
const PostListing = ({ currentData }) => {
    ...
    const filteredPosts = postStates.filter((post) => post.entity.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    return (
        <>
            <div className="w-9/12">
                <div className=" flex justify-center items-center font-serif text-xl mt-6 ">Posts List</div>
                                ...
                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        {currentPosts.map((post, index) => (
                                            <tr
                                                onClick={() =>
                                                    navigate(`/admin/admin_viewpost?post=${post.id}`, {
                                                        state: { postData: post },
                                                    })
                                                }
                                                key={post.id}
