...
import { AdminEditFranchise } from "../../../services/admin/apiMethods";


function FranchiseViewPost() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async () => {
            ...
            try {
                const response = await AdminEditFranchise(formData, postId);
                if (response.data.status === true) {
                    toast.success("Franchise Post Updated Successfull");
                    resetState1();
                    resetState2();
                    resetState3();
                    setLoading(!loading);
...
export default FranchiseViewPost;
