...
import { AdminEditBusiness } from "../../../services/admin/apiMethods";

function BusinessViewPost() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async () => {
            ...
            try {
                const response = await AdminEditBusiness(formData, postId);
                if (response.data.status === true) {
                    toast.success("Business Post Updated Successfull");
                    resetState1();
                    resetState2();
                    resetState3();
                    setLoading(!loading);
...
export default BusinessViewPost;
