                    ...
                    {isLocationQuestion ? (
                        <div className="space-y-4">
                            ...
                            {selectedStates.length > 0 && (
                                <div className="mt-2">
                                    <h4 className="font-medium mb-1 text-black">Selected States:</h4>
                            ...
                            {selectedCities.length > 0 && (
                                <div className="mt-4">
                                    <h4 className="font-medium mb-2 text-black">Selected Cities:</h4>
                                            ...
                                            {Object.entries(groupedCities).map(([state, cities]) => (
                                                ...
                                                >
                                                    <div className="flex justify-between items-center mb-2">
                                                        <h5 className="font-medium text-black">{state}</h5>
                                                        <button 
                                                            onClick={() => removeState(state)}
