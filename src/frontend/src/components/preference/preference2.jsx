...
const PreferencesForm = () => {
    ...
    //For dropdown select, state and city
                        ...
                        <div className="space-y-4">
                            <StateSelect
                                ...
                                onChange={(value) => {
                                    ...
                                    handleFormDataChange(questionKey, value.name, false, "state"); // Update form state
                                }}
                            ...
                            <CitySelect
                                ...
                                stateid={selectedState?.id} // Load cities for the selected state
                                onChange={(value) => {
                                    setSelectedCity(value);
                                    handleFormDataChange(questionKey, value.name, false, "city"); // Update form city
                                }}
