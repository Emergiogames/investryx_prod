    ...
    return (
        <div className="w-full relative">
            <div className="multiple-slide-carousel swiper-container relative">
                <div className="text-5xl font-medium mb-5 ml-24 mt-28 text-center">Featured Listing </div>
                <Swiper
                    ref={swiperRef}
                    modules={[Navigation]}
                    loop={true}
                                ...
                                <div className="flex justify-between items-center w-full pb-4 mb-auto">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex flex-1">
                                            <div className="">
                                                <p className="text-sm font-semibold">{post.entity_type}</p>
                                                <p className="text-sm text-gray-500">Published on {post.listed_on}</p>
                                            </div>
                                        </div>
                                    </div>
             ...
             <path d="M10.0002 11.9999L6 7.99971L10.0025 3.99719" stroke="currentColor" strokeWidth="1.6" stroke-linecap="round" stroke-linejoin="round" />
           </svg> */}
                    </button>
                    ...
                    >
                        {/* <svg class="h-5 w-5 text-indigo-600 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
             <path d="M5.99984 4.00012L10 8.00029L5.99748 12.0028" stroke="currentColor" strokeWidth="1.6" stroke-linecap="round" stroke-linejoin="round" />
           </svg> */}
                    </button>
                </div>
            </div>
