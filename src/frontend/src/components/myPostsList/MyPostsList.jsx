...
function MyPostsList({ myPosts }) {
    ...
    console.log("profiellslss", profile);
                    ...
                    myPosts.map((post) => (
                        <div key={post.id} className="flex md:w-full m-2 md:m-4 bg-gray-50 rounded-2xl">
                            <img
                                ...
                                src={post.image1 ? `${BASE_URL}${post.image1}` : "https://dummyimage.com/200x200/000/fff"}
                                ...
                                <div className="flex justify-around">
                                    ...
                                    <div className="relative">
                                        <div
                                            ...
                                            className="flex items-center lg:gap-x-2 cursor-pointer  hover:bg-gray-200 rounded-lg"
                                        >
