        ...
        <Card className="p-3 m-5 hover:cursor-pointer" sx={{ maxWidth: 400, position: "relative" }}>
                ...
                avatar={
                    post.logo ? (
                        <div className="w-12 h-12">
                            <img className="rounded-full" src={post.logo} alt={`img-${post.name}`} />
                        </div>
                    ) : (
            ...
            <CardContent>
                <Typography variant="body2" color="text.secondary">
                    Posted by : {post.name ? post.name : "Nil"}
                    <br/>                    
                    Location: {post.city ? post.name : "Nil"}
                    <br />
                    EBITDA: {post.ebitda ? post.ebitda : "Nil"} %
                </Typography>
            </CardContent>
            ...
            <Collapse in={expanded} timeout="auto" unmountOnExit>
                <CardContent>
                    ...
                    <Typography>Type: {post.type_sale ? post.type_sale : "Nil"}</Typography>
                </CardContent>
            </Collapse>
        </Card>
    );
